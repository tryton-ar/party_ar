...
name = 'trytonar_party_ar'

download_url = 'https://github.com/tryton-ar/party_ar/tree/%s.%s' % (
...
setup(name=name,
    ...
    package_dir={'trytond.modules.party_ar': '.'},
    packages=[
        'trytond.modules.party_ar',
        'trytond.modules.party_ar.tests',
        ],
    package_data={
        'trytond.modules.party_ar': (info.get('xml', [])
    ...
    entry_points="""
    [trytond.modules]
    party_ar = trytond.modules.party_ar
    """,
    test_suite='tests',
